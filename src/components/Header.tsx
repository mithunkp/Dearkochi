    ...
    return (
        <header className="flex justify-between items-center px-8 py-4 bg-white/85 backdrop-blur-xl border-b border-white/40 sticky top-0 z-50">
            ...
            {/* <nav className="hidden md:flex gap-2.5">
                <button className="px-5 py-2.5 rounded-full border-none text-sm cursor-pointer transition-all duration-200 bg-[#111] text-white font-medium">
                    Overview
                </button>
                <button className="px-5 py-2.5 rounded-full border-none text-sm cursor-pointer transition-all duration-200 bg-transparent text-slate-600 hover:bg-black/5 font-medium">
                    Analytics
                </button>
                <button className="px-5 py-2.5 rounded-full border-none text-sm cursor-pointer transition-all duration-200 bg-transparent text-slate-600 hover:bg-black/5 font-medium">
                    Outage Reports
